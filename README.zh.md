...
*   **极致性能**：在 **NVIDIA GTX 1650 Ti 4GB** 笔记本显卡上，运行 **Gemma 2B Q6_K** 模型，推理速度达到 **37.4 tok/s**，显存带宽利用率高达 **52.6%**，触及该入门级显卡的物理极限。
...
| :--- | :--- | :--- | :--- |
| **解码速度** | **37.4 tok/s** | 35–45 tok/s | 打平 / 互有胜负 |
| **首字延迟 (TTFT)** | ~30ms | ~20-25ms | 略微落后，但在可接受范围 |
| **二进制体积** | **~4 MB** | >100 MB | **SychicAI 胜** |
